import subprocess
print " Welcome to Login Server Builder "
print 'when entering the email and password for the script put'
print 'quotations around the email and password IE:"example@example.com"'
print "\r\n"
...
print "your Login Server will in the the LoginServer Folder"
