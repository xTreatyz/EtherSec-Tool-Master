...
print "     file to \LoginServer\Setup, once youve completed those steps"
print "     your Login Server will in the the LoginServer Folder to install"
print "     to remote computer simply run the Istallation & Run.bat it will"
print "     install the python programming language and modules needed for"
print "     script and automatically Run in background and add the Startup"
